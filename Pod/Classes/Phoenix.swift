...
public struct Phoenix {
  ...
  open class Channel {
     ...
     */
    init(topic: String, message: Phoenix.Message, callback: @escaping ((AnyObject) -> Void), socket: Phoenix.Socket) {
     ...
     */
    open func on(_ event: String, callback: @escaping ((AnyObject) -> Void)) {
